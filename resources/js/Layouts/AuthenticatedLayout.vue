<template>
    <div class="h-screen bg-gray-50 flex w-full gap-4">
        ...
        :class="dargOver ? 'dropzone' : ''">

            <template v-if="dargOver" class="text-gray-500 text-center py-8 text-sm">
    ...
    fileUploadForm.post(route('file.store'),{
        ...
        onError: errors => {
            ...
            if(Object.keys(errors).length > 0){
                ...
                message = 'Error while file upload . Please try again later'
            }
